...
A thought was in the current form to use the registration of the knob being interacted with as a value change in the midi script and the toggle reversing the direction of the increment although crude might allow some value control via the current messaging. 
